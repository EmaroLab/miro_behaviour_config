...
#from mdk.....miro_ros_client_gui import miro_ros_client_gui
...
class miro_ros_client_gui:
    ...
    def on_window_main_destroy(self, object, data=None):
        ...
        Gtk.main_quit()
        self.terminate_rosparam_check = True
        self.rosparam_checker.join()
            ...
            if self.do_config:
                ...
                if self.do_config == 0:
                    ...
                    if self.chk_branch_enable.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.BRANCH_ENABLE,True)
                    else: rospy.set_param(self.param_root_path + self.BRANCH_ENABLE,False)
                    
                    if self.chk_affect_enable.get_active():
                         c.P2U_W_affect_signals = c.P2U_W_affect_signals | miro.MIRO_P2U_W_AFFECT_ENABLE
                         rospy.set_param(self.param_root_path + self.AFFECT_ENABLE,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_ENABLE,False)
                    
                    if self.chk_affect_adjust_rtc.get_active():
                         c.P2U_W_affect_signals = c.P2U_W_affect_signals | miro.MIRO_P2U_W_AFFECT_ADJUST_RTC
                         rospy.set_param(self.param_root_path + self.AFFECT_ADJUST_RTC,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_ADJUST_RTC,False)
                    ...
                    if self.chk_affect_valence_dynamics.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.AFFECT_VALENCE_DYNAMICS,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_VALENCE_DYNAMICS,False)
                    ...
                    if self.chk_affect_arousal_dynamics.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.AFFECT_AROUSAL_DYNAMICS,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_AROUSAL_DYNAMICS,False)
                    ...
                    if self.chk_affect_enable_sleep.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.AFFECT_ENABLE_SLEEP,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_ENABLE_SLEEP,False)
                    
                    if self.chk_affect_from_clock.get_active():
                         c.P2U_W_affect_signals = c.P2U_W_affect_signals | miro.MIRO_P2U_W_AFFECT_FROM_CLOCK
                         rospy.set_param(self.param_root_path + self.AFFECT_FROM_CLOCK,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_FROM_CLOCK,False)
                    ...
                    else: rospy.set_param(self.param_root_path + self.AFFECT_FROM_TOUCH,False)
                    
                    if self.chk_affect_from_light.get_active():
                         c.P2U_W_affect_signals = c.P2U_W_affect_signals | miro.MIRO_P2U_W_AFFECT_FROM_LIGHT
                         rospy.set_param(self.param_root_path + self.AFFECT_FROM_LIGHT,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_FROM_LIGHT,False)
                    
                    if self.chk_affect_from_sound.get_active():
                         c.P2U_W_affect_signals = c.P2U_W_affect_signals | miro.MIRO_P2U_W_AFFECT_FROM_SOUND
                         rospy.set_param(self.param_root_path + self.AFFECT_FROM_SOUND,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_FROM_SOUND,False)
                    
                    if self.chk_affect_from_accel.get_active():
                         c.P2U_W_affect_signals = c.P2U_W_affect_signals | miro.MIRO_P2U_W_AFFECT_FROM_ACCEL
                         rospy.set_param(self.param_root_path + self.AFFECT_FROM_ACCEL,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_FROM_ACCEL,False)
                    ...
                    if self.chk_affect_from_sleep_blocked.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.AFFECT_FROM_SLEEP_BLOCKED,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_FROM_SLEEP_BLOCKED,False)
                    ...
                    if self.chk_affect_randomize_valence.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.AFFECT_RANDOMIZE_VALENCE,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_RANDOMIZE_VALENCE,False)
                    ...
                    if self.chk_affect_fast_sleep_dynamics.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.AFFECT_FAST_SLEEP_DYNAMICS,True)
                    else: rospy.set_param(self.param_root_path + self.AFFECT_FAST_SLEEP_DYNAMICS,False)
                    
                    if self.chk_express_enable.get_active():
                         c.P2U_W_express_signals = c.P2U_W_express_signals | miro.MIRO_P2U_W_EXPRESS_ENABLE
                         rospy.set_param(self.param_root_path + self.EXPRESS_ENABLE,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_ENABLE,False)
                    ...
                    if self.chk_express_through_light.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_LIGHT,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_LIGHT,False)
                    ...
                    if self.chk_express_through_tail.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_TAIL,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_TAIL,False)
                    ...
                    if self.chk_express_through_eyelids.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_EYELIDS,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_EYELIDS,False)
                    ...
                    if self.chk_express_through_ears.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_EARS,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_EARS,False)
                    ...
                    if self.chk_express_through_vocal.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_VOCAL,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_THROUGH_VOCAL,False)
                    ...
                    else: rospy.set_param(self.param_root_path + self.DEBUG_SONAR,False)
                    ...
                    if self.chk_express_no_pirate_noises.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.EXPRESS_NO_PIRATE_NOISES,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_NO_PIRATE_NOISES,False)
                    ...
                    if self.chk_express_do_pirate_noises.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.EXPRESS_DO_PIRATE_NOISES,True)
                    else: rospy.set_param(self.param_root_path + self.EXPRESS_DO_PIRATE_NOISES,False)
                    
                    if self.chk_action_enable.get_active():
                         c.P2U_W_action_signals = c.P2U_W_action_signals | miro.MIRO_P2U_W_ACTION_ENABLE
                         rospy.set_param(self.param_root_path + self.ACTION_ENABLE,True)
                    else: rospy.set_param(self.param_root_path + self.ACTION_ENABLE,False)
                    
                    if self.chk_action_debug.get_active():
                         c.P2U_W_action_signals = c.P2U_W_action_signals | miro.MIRO_P2U_W_ACTION_DEBUG
                         rospy.set_param(self.param_root_path + self.ACTION_DEBUG,True)
                    else: rospy.set_param(self.param_root_path + self.ACTION_DEBUG,False)
                    
                    if self.chk_action_force_mull.get_active():
                         c.P2U_W_action_signals = c.P2U_W_action_signals | miro.MIRO_P2U_W_ACTION_FORCE_MULL
                         rospy.set_param(self.param_root_path + self.ACTION_FORCE_MULL,True)
                    else: rospy.set_param(self.param_root_path + self.ACTION_FORCE_MULL,False)
                    ...
                    if self.chk_action_randomize_orient.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.ACTION_RANDOMIZE_ORIENT,True)
                    else: rospy.set_param(self.param_root_path + self.ACTION_RANDOMIZE_ORIENT,False)
                    ...
                    if self.chk_action_disable_halt.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.ACTION_DISABLE_HALT,True)
                    else: rospy.set_param(self.param_root_path + self.ACTION_DISABLE_HALT,False)
                    ...
                    else: rospy.set_param(self.param_root_path + self.BODY_ENABLE,False)
                    ...
                    if self.chk_body_reset_kc_integrators.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.BODY_RESET_KC_INTEGRATORS,True)
                    else: rospy.set_param(self.param_root_path + self.BODY_RESET_KC_INTEGRATORS,False)
                    
                    if self.chk_body_no_push.get_active():
                         c.P2U_W_body_signals = c.P2U_W_body_signals | miro.MIRO_P2U_W_BODY_NO_PUSH
                         rospy.set_param(self.param_root_path + self.BODY_NO_PUSH,True)
                    else: rospy.set_param(self.param_root_path + self.BODY_NO_PUSH,False)
                    
                    if self.chk_body_no_push_motion.get_active():
                         c.P2U_W_body_signals = c.P2U_W_body_signals | miro.MIRO_P2U_W_BODY_NO_PUSH_MOTION
                         rospy.set_param(self.param_root_path + self.BODY_NO_PUSH_MOTION,True)
                    else: rospy.set_param(self.param_root_path + self.BODY_NO_PUSH_MOTION,False)
                    ...
                    if self.chk_body_no_push_translation.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.BODY_NO_PUSH_TRANSLATION,True)
                    else: rospy.set_param(self.param_root_path + self.BODY_NO_PUSH_TRANSLATION,False)
                    ...
                    if self.chk_body_no_push_into_sonar.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.BODY_NO_PUSH_INTO_SONAR,True)
                    else: rospy.set_param(self.param_root_path + self.BODY_NO_PUSH_INTO_SONAR,False)
                    
                    if self.chk_enable_pos_control.get_active():
                         c.P2L_W_signals = c.P2L_W_signals | miro.MIRO_P2L_W_ENABLE_POS_CONTROL
                         rospy.set_param(self.param_root_path + self.ENABLE_POS_CONTROL,True)
                    else: rospy.set_param(self.param_root_path + self.ENABLE_POS_CONTROL,False)
                    
                    if self.chk_enable_cliff_reflex.get_active():
                         c.P2L_W_signals = c.P2L_W_signals | miro.MIRO_P2L_W_ENABLE_CLIFF_REFLEX
                         rospy.set_param(self.param_root_path + self.ENABLE_CLIFF_REFLEX,True)
                    else: rospy.set_param(self.param_root_path + self.ENABLE_CLIFF_REFLEX,False)
                    ...
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_IGNORE_AUDIO,False)
                    
                    if self.chk_spatial_ignore_video.get_active():
                         c.P2S_W_signals = c.P2S_W_signals | miro.MIRO_P2S_W_SPATIAL_IGNORE_VIDEO
                         rospy.set_param(self.param_root_path + self.SPATIAL_IGNORE_VIDEO,True)
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_IGNORE_VIDEO,False)
                    
                    if self.chk_spatial_send_priority.get_active():
                         c.P2S_W_signals = c.P2S_W_signals | miro.MIRO_P2S_W_SPATIAL_SEND_PRIORITY
                         rospy.set_param(self.param_root_path + self.SPATIAL_SEND_PRIORITY,True)
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_SEND_PRIORITY,False)
                    
                    if self.chk_spatial_send_other.get_active():
                         c.P2S_W_signals = c.P2S_W_signals | miro.MIRO_P2S_W_SPATIAL_SEND_OTHER
                         rospy.set_param(self.param_root_path + self.SPATIAL_SEND_OTHER,True)
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_SEND_OTHER,False)
                    ...
                    if self.chk_spatial_no_reaff_compromise.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.SPATIAL_NO_REAFF_COMPROMISE,True)
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_NO_REAFF_COMPROMISE,False)
                    
                    if self.chk_spatial_no_suppress.get_active():
                         c.P2S_W_signals = c.P2S_W_signals | miro.MIRO_P2S_W_SPATIAL_NO_SUPPRESS
                         rospy.set_param(self.param_root_path + self.SPATIAL_NO_SUPPRESS,True)
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_NO_SUPPRESS,False)
                    
                    if self.chk_spatial_show_compromise.get_active():
                         c.P2S_W_signals = c.P2S_W_signals | miro.MIRO_P2S_W_SPATIAL_SHOW_COMPROMISE
                         rospy.set_param(self.param_root_path + self.SPATIAL_SHOW_COMPROMISE,True)
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_SHOW_COMPROMISE,False)
                    ...
                    if self.chk_spatial_show_test_pattern.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.SPATIAL_SHOW_TEST_PATTERN,True)
                    else: rospy.set_param(self.param_root_path + self.SPATIAL_SHOW_TEST_PATTERN,False)
                    ...
                    if self.chk_test_alarm.get_active():
                         ...
                         rospy.set_param(self.param_root_path + self.TEST_ALARM,True)
...
#        print("Bheaviour controlling flag (see ROS param): " + obj.get_label())
    ...
    def __init__(self):
        ...
        for arg in sys.argv[1:]:
            ...
            elif key == "gui_template":
                self.opt.gui_template = val
            else:
                print("argument not recognised \"" + arg + "\"")
        ...
        if self.opt.robot_is_phys is None:
            if self.opt.robot_name[:3] == "rob":
                self.opt.robot_is_phys = True
                print("robot_name: " + self.opt.robot_name + " inferred that robot server is a physical robot from its name")
            else:
                self.opt.robot_is_phys = False
                print("robot_name: " + self.opt.robot_name + " inferred that robot server is a simulated robot from its name")

        self.param_root_path = rospy.get_param("MIRO_PARAM_ROOT", "/" + self.opt.robot_name + "/behaviour/flagConfig/")

        # initialise
        self.builder = Gtk.Builder()
        print self.opt.gui_template
        self.builder.add_from_file( self.opt.gui_template)#"miro_ros_client_gui.glade")
    ...
    def update_ros_param(self):
        ...
        while not rospy.is_shutdown():
            ...
            try:
                ...
                self.checkParam(self.AFFECT_AROUSAL_DYNAMICS)
                self.checkParam(self.AFFECT_ENABLE_SLEEP)
                self.checkParam(self.AFFECT_FROM_CLOCK)
                ...
                self.checkParam(self.AFFECT_FAST_SLEEP_DYNAMICS)
                self.checkParam(self.EXPRESS_ENABLE)
                self.checkParam(self.EXPRESS_THROUGH_LIGHT)
                ...
                self.checkParam(self.BODY_NO_PUSH_TRANSLATION)
                self.checkParam(self.BODY_NO_PUSH_INTO_SONAR)
                ...
                self.checkParam(self.SPATIAL_NO_SUPPRESS)
                self.checkParam(self.SPATIAL_SHOW_COMPROMISE)
                self.checkParam(self.SPATIAL_SHOW_TEST_PATTERN)
    ...
    AFFECT_VALENCE_DYNAMICS = "AFFECT_VALENCE_DYNAMICS"
    AFFECT_AROUSAL_DYNAMICS = "AFFECT_AROUSAL_DYNAMICS"
    AFFECT_ENABLE_SLEEP = "AFFECT_ENABLE_SLEEP"
    AFFECT_FROM_CLOCK = "AFFECT_FROM_CLOCK"
    AFFECT_FROM_WAKEFULNESS = "AFFECT_FROM_WAKEFULNESS"
    AFFECT_FROM_TOUCH = "AFFECT_FROM_TOUCH"
    AFFECT_FROM_LIGHT = "AFFECT_FROM_LIGHT"
    AFFECT_FROM_SOUND = "AFFECT_FROM_SOUND"
    AFFECT_FROM_ACCEL = "AFFECT_FROM_ACCEL"
    AFFECT_FROM_SLEEP_BLOCKED = "AFFECT_FROM_SLEEP_BLOCKED"
    AFFECT_RANDOMIZE_VALENCE = "AFFECT_RANDOMIZE_VALENCE"
    AFFECT_FAST_SLEEP_DYNAMICS = "AFFECT_FAST_SLEEP_DYNAMICS"
    EXPRESS_ENABLE = "EXPRESS_ENABLE"
    EXPRESS_THROUGH_LIGHT = "EXPRESS_THROUGH_LIGHT"
    EXPRESS_THROUGH_TAIL = "EXPRESS_THROUGH_TAIL"
    EXPRESS_THROUGH_EYELIDS = "EXPRESS_THROUGH_EYELIDS"
    EXPRESS_THROUGH_EARS = "EXPRESS_THROUGH_EARS"
    EXPRESS_THROUGH_VOCAL = "EXPRESS_THROUGH_VOCAL"
    EXPRESS_THROUGH_BODY = "EXPRESS_THROUGH_BODY"
    DEBUG_SONAR = "DEBUG_SONAR"
    EXPRESS_NO_PIRATE_NOISES = "EXPRESS_NO_PIRATE_NOISES"
    EXPRESS_DO_PIRATE_NOISES = "EXPRESS_DO_PIRATE_NOISES"
    ACTION_ENABLE = "ACTION_ENABLE"
    ACTION_DEBUG = "ACTION_DEBUG"
    ACTION_FORCE_MULL = "ACTION_FORCE_MULL"
    ACTION_RANDOMIZE_ORIENT = "ACTION_RANDOMIZE_ORIENT"
    ACTION_DISABLE_HALT = "ACTION_DISABLE_HALT"
    ACTION_MODULATE_BY_SONAR = "ACTION_MODULATE_BY_SONAR"
    BODY_ENABLE = "BODY_ENABLE"
    BODY_RESET_KC_INTEGRATORS = "BODY_RESET_KC_INTEGRATORS"
    BODY_NO_PUSH = "BODY_NO_PUSH"
    BODY_NO_PUSH_MOTION = "BODY_NO_PUSH_MOTION"
    BODY_NO_PUSH_TRANSLATION = "BODY_NO_PUSH_TRANSLATION"
    BODY_NO_PUSH_INTO_SONAR = "BODY_NO_PUSH_INTO_SONAR"
    ENABLE_POS_CONTROL = "ENABLE_POS_CONTROL"
    ENABLE_CLIFF_REFLEX = "ENABLE_CLIFF_REFLEX"
    SPATIAL_ENABLE = "SPATIAL_ENABLE"
    SPATIAL_IGNORE_AUDIO = "SPATIAL_IGNORE_AUDIO"
    SPATIAL_IGNORE_VIDEO = "SPATIAL_IGNORE_VIDEO"
    SPATIAL_SEND_PRIORITY = "SPATIAL_SEND_PRIORITY"
    SPATIAL_SEND_OTHER = "SPATIAL_SEND_OTHER"
    SPATIAL_NO_REAFF_COMPROMISE = "SPATIAL_NO_REAFF_COMPROMISE"
    SPATIAL_NO_SUPPRESS = "SPATIAL_NO_SUPPRESS"
    SPATIAL_SHOW_COMPROMISE = "SPATIAL_SHOW_COMPROMISE"
    SPATIAL_SHOW_TEST_PATTERN = "SPATIAL_SHOW_TEST_PATTERN"
    TEST_ALARM = "TEST_ALARM"

if __name__ == "__main__":
    rospy.init_node("miro_behaviour_controller", anonymous=True)
